    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <a href="#" class="brand-link">
                <img src="{{ asset('/images/chicken.png') }}" alt="AdminLTE Logo"
            ...
            <x-side-nav>
                ...
                <x-side-nav-item name="Riders">
                    <ion-icon class="nav-icon" name="bicycle-outline"></ion-icon>
                </x-side-nav-item>
                <x-side-nav-item name="Orders">
                    <ion-icon class="nav-icon" name="clipboard-outline"></ion-icon>
                </x-side-nav-item>
            </x-side-nav>
        </aside>
